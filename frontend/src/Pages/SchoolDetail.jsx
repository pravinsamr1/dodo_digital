  ...
  const activeTabContent = useMemo(() => {
    ...
    const content = {
      'School Details': {
        ...
        items: [
          ['Student teacher ratio', school.ratio || '30:1'],
          ['Language of instruction', school.languages || 'English, Hindi'],
          ['Grade', school.grade],
          ['Board', school.board],
        ],
      },
      Facilities: {
        ...
        items: [
          ['Smart Classrooms', school.smartClasses || 'Available with interactive boards'],
          ['Laboratories', school.labs || 'Physics, Chemistry, Biology, and Computer Labs'],
          ['Library', school.library || 'Well-stocked with 10,000+ books'],
          ['Sports Complex', school.sports || 'Indoor stadium, swimming pool, football ground'],
          ['Transport', school.transport || 'GPS-enabled AC buses covering 30km radius'],
          ['Medical Room', school.medical || 'Full-time nurse and doctor on call'],
        ],
      },
      'Fees Structure': {
        icon: IndianRupee,
      ...
      'Extra Activities': {
        ...
        items: [
          ['Performing Arts', school.performingArts || 'Classical Dance, Western Music, Drama'],
          ['Clubs & Societies', school.clubs || 'Robotics, Coding, Eco Club, Literary Society'],
          ['Sports Training', school.sportsTraining || 'Cricket, Football, Basketball, Tennis, Swimming'],
      ...
      Admission: {
        ...
        items: [
          ...
          ['Documents', school.documents || 'Birth certificate, transfer certificate, marksheet'],
          ['Interaction', school.interaction || 'Parent counselling and student assessment'],
        ],
      },
      Gallery: {
        icon: ImageIcon,
